...
def raze_fetch_remote_crates():
    ...
    maybe(
        ...
        build_file = Label("//third_party/cargo/remote:BUILD.derivative-2.1.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/cargo/remote:BUILD.num_enum-0.5.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/cargo/remote:BUILD.num_enum_derive-0.5.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/cargo/remote:BUILD.syn-1.0.56.bazel"),
    )
